...
clone_or_pull https://github.com/ANYANTUDRE/Florence-2-Vision-Language-Model.git
...
#comfy s3 downloader
clone_or_pull https://github.com/TemryL/ComfyS3.git

#civit AI downloader
clone_or_pull https://github.com/ashleykleynhans/civitai-downloader.git
...
clone_or_pull https://github.com/lldacing/ComfyUI_PuLID_Flux_ll.git
clone_or_pull https://github.com/chetusangolgi/Comfyui-supabase.git
clone_or_pull https://github.com/tsogzark/ComfyUI-load-image-from-url.git
